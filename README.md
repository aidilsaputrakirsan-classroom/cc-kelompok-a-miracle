...
| Service | URL |
| --- | --- |
| Frontend lokal | [http://localhost](http://localhost) |
| API Gateway lokal | [http://localhost/health](http://localhost/health) |
| Auth Service health | [http://localhost/auth/health](http://localhost/auth/health) |
| Donor Service health | [http://localhost/donor/health](http://localhost/donor/health) |
| Public blood stock | [http://localhost/api/public/blood-stock](http://localhost/api/public/blood-stock) |

> Production URL mengikuti hasil deployment Railway tim dan dicatat pada `docs/production-test.md`.
