...
const StatCard = ({ title, value, subtitle, icon: Icon, color, onClick }) => (
  <div
    onClick={onClick}
    className={`bg-white p-6 rounded-2xl border border-slate-100 shadow-sm dark:bg-slate-900 dark:border-slate-800 transition-all ${
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-slate-900 -m-6 lg:-m-10 p-6 lg:p-10 mb-8 text-white rounded-b-[3rem] shadow-lg shadow-indigo-900/20 dark:from-indigo-950 dark:via-indigo-900 dark:to-slate-950 transition-colors">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            disabled={refreshing}
            className="shrink-0 mt-1 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-white/80 hover:text-white text-xs font-semibold transition-all disabled:opacity-50"
            title="Perbarui data"
          >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Stok Donor per Golongan Darah</h2>
          ...
          <Droplets className="w-5 h-5 text-[#660000] dark:text-red-400" />
        </div>
          ...
          {BLOOD_TYPES.map((type) => {
            ...
            return (
              <button
                ...
                className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-4 text-center hover:border-[#660000]/40 dark:hover:border-red-400/30 hover:shadow-lg hover:shadow-[#660000]/5 dark:hover:shadow-red-900/10 transition-all group cursor-pointer"
              >
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#660000]/8 dark:bg-red-400/10 text-[#660000] dark:text-red-400 font-black text-sm mb-2 group-hover:bg-[#660000]/15 dark:group-hover:bg-red-400/20 transition-colors border border-[#660000]/10 dark:border-red-400/15">
                  {type}
                </span>
                <p className="text-3xl font-black text-slate-900 dark:text-white leading-none mb-1">{count}</p>
                <p className="text-[10px] text-slate-400 dark:text-slate-500 uppercase font-semibold tracking-wider">pendonor</p>
                <div className="mt-2 flex items-center justify-center gap-0.5 text-[10px] text-[#660000]/50 dark:text-red-400/40 opacity-0 group-hover:opacity-100 transition-opacity">
                  <span>Lihat</span>
