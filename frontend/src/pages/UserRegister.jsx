...
export const UserRegister = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-[#660000]/5 dark:from-slate-950 dark:via-slate-900 dark:to-[#660000]/10 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <Link to="/login" className="inline-flex items-center gap-2 text-slate-600 hover:text-[#660000] dark:text-slate-400 dark:hover:text-red-400 mb-8 font-semibold transition-colors group">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 border border-slate-100 dark:border-slate-800 backdrop-blur-xl"
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 flex items-center gap-1">
              ...
              <input 
                ...
                required
                placeholder="Intania"
                className="w-full px-4 py-3.5 bg-slate-100 dark:bg-slate-800 border-2 border-transparent rounded-2xl focus:outline-none focus:bg-white dark:focus:bg-slate-900 focus:border-[#660000] dark:focus:border-red-500 focus:ring-4 focus:ring-[#660000]/10 dark:focus:ring-red-500/20 transition-all text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 font-medium"
                value={nama}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full px-4 py-3.5 bg-slate-100 dark:bg-slate-800 border-2 border-transparent rounded-2xl focus:outline-none focus:bg-white dark:focus:bg-slate-900 focus:border-[#660000] dark:focus:border-red-500 focus:ring-4 focus:ring-[#660000]/10 dark:focus:ring-red-500/20 transition-all text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 font-medium pr-12"
                  value={password}
                ...
                <button 
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors p-1 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg"
                >
                  {showPassword ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                </button>
              </div>
              <div className="mt-3 p-4 bg-gradient-to-r from-blue-50 to-blue-50/50 dark:from-blue-950/30 dark:to-blue-950/10 rounded-2xl border border-blue-100 dark:border-blue-900/50">
          ...
          >
            <p className="text-slate-600 dark:text-slate-400 text-sm font-medium">
              Sudah punya akun?{' '}
              <Link to="/login?type=user" className="text-[#660000] dark:text-red-400 font-bold hover:text-[#8b0000] dark:hover:text-red-300 transition-colors underline-offset-2 hover:underline">
                Masuk Disini
              </Link>
            </p>
          </motion.div>
