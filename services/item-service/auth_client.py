...
Dilengkapi dengan retry logic, circuit breaker, dan correlation ID (Modul 14.2).
"""
import os
import time
import asyncio
...
async def _call_auth_service(
    ...
    correlation_id diteruskan ke Auth Service agar log bisa dihubungkan lintas service.
    """
...
async def verify_token_with_auth_service(
    ...
    Meneruskan correlation_id dari request.state agar log lintas service terhubung.
    """
